    ...
    <div className="space-y-8">
      ...
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
        ...
        <div className="divide-y divide-gray-200">
          {schedules.map(schedule => (
            <div key={schedule.dayOfWeek} className="px-6 py-5 hover:bg-gray-50 transition-colors">
      ...
      <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-lg border border-amber-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <p className="text-sm text-gray-600 mb-1">Horario más común</p>
            <p className="text-2xl font-bold text-black">
      ...
      <div className="flex gap-3 justify-end">
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="px-6 py-2.5 text-sm font-medium text-white bg-amber-600 rounded-lg hover:bg-amber-700 transition-colors flex items-center gap-2 disabled:opacity-50"
        >
